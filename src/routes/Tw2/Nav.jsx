...
class Header extends React.Component {
  ...
  render() {
    ...
    const navData = [{ menu: '首頁',url:'http://www.gamegold.xin/index.html'}, {menu: '產品介紹',url:'/'}, {menu: '行業應用',url:'http://www.gamegold.xin/hyyy.html'}, {menu: '關於我們',url:'http://www.gamegold.xin/gywm.html'} ];;
