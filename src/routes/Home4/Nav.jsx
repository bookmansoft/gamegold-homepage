...
class Header extends React.Component {
  ...
  render() {
    ...
    const navData = [{ menu: '首页',url:'http://www.gamegold.xin/index.html'}, {menu: '产品介绍',url:'http://www.gamegold.xin/cpjs.html'}, {menu: '行业应用',url:'http://www.gamegold.xin/hyyy.html'}, {menu: '关于我们',url:'/'} ];;
