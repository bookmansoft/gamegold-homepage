...
class Footer extends React.Component {
  ...
  render() {
    ...
    const dataSource = [
      ...
      { title: '关注', content: 'https://zos.alipayobjects.com/rmsportal/AXtqVjTullNabao.svg\n https://zos.alipayobjects.com/rmsportal/fhJykUTtceAhYFz.svg', contentLink: 'https://github.com/orgs/bookmansoft/dashboard\n http://www.gamegold.xin' },
    ];
    ...
    >
      ...
      >
        <span>
          Copyright © 2016 The Project by <a href="http://www.gamegold.xin">Ant Motion</a>. All Rights Reserved
        </span>
      </TweenOne>
    </OverPack>);
  }
