...
class Header extends React.Component {
  ...
  render() {
    ...
    const navData = [{ menu: 'Home page',url:'/#/En'}, {menu: 'Product',url:'/#/En2'}, {menu: 'Industry',url:'/#/En3'}, {menu: 'About',url:'/#/En4'}, {menu: 'Game',url:'/#/En5'}, {menu: '繁體中文',url:'/#/Tw'}, {menu: '简体中文',url:'/#/Home'} ];
